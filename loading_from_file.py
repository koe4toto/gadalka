...
# Запуск обработки
# TODO Нужно переписать так, чтобы данные преобразовывать в CSV, грузить во временную таблицу
# TODO Валидировать данные нужно при переносе из временной таблицы в чистовую средствами БД
